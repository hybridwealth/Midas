...
def request_money():
    ...
    requester_data = requester.to_dict()
    receiver_identifier = input("Enter the receiver's Username or Account ID: ")
    ...
    amount = float(input("Enter amount to request (maximum 10,000): "))
    if amount > 10000:
        print("Amount exceeds the maximum limit of 10,000.")
        return

    print(f"Request of {amount} {requester_data['base_currency']} sent to {receiver_data['first_name']} {receiver_data['last_name']}")
